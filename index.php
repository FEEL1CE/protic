...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      ...
      <h2>Kembangkan Keterampilan
        Anda Dengan Bergabung
        Bersama Kami</h2>
      <div class="d-flex">
  ...
  <main id="main">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon text-center">
                <img class="change-color-img" src="assets/img/icons/website-coding.svg" width="48px" height="48px"></div>
              <h4 class="title text-center">Web Programing</a></h4>
              <p class="description">Proses pengembangan aplikasi website dengan menggunakan bahasa HTML, CSS,
                JavaScript.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="icon text-center"><img src="assets/img/icons/editor.svg" width="48px" height="48px"></i></div>
              <h4 class="title text-center">UI/UX Design</a></h4>
              <p class="description">Proses menampilkan sebuah hasil dalam bentuk tampilan yang dapat dilihat oleh
                pengguna.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
              <div class="icon text-center"><img src="assets/img/icons/mobile.svg" width="48px" height="48px"></i></div>
              <h4 class="title text-center">Mobile Programming</h4>
              <p class="description"> Proses mengembangkan aplikasi untuk mendukung fungsi dari ponsel.</p>
            </div>
          </div>

          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="400">
              <div class="icon text-center"><img src="assets/img/icons/smart-house.svg" width="48px" height="48px"></div>
              <h4 class="title text-center">Internet Of Things</a></h4>
              <p class="description">Proses mengembangkan teknologi yang memungkinkan benda-benda di sekitar kita
                terhubung dengan jaringan internet.</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up"
            ...
            <p class="fst-italic">
              Menyalurkan minat dan bakat mahasiswa dalam bidang pemrograman komputer menjadi sebuah prestasi, baik di
              tingkat Perguruan Tinggi, Regional, Nasional, maupun Internasional. Sehingga memberikan nama baik bagi
            ...
            <ul>
              <li>
                ...
                <div>
                  <h5>Visi Protic</h5>
                  <p style="text-align: justify;">Menjadikan ukm penalaran pemrograman politeknik negeri cilacap sebagai
                    wadah untuk menampung, mengembangkan, dan menyalurkan kreativitas di bidang penalaran pemrograman
                    secara professional dan dapat bersaing di tingkat nasional.</p>
                </div>
              </li>
              <li>
                ...
                <div>
                  <h5>Misi Protic</h5>
                  <p style="text-align: justify;">1. Menyelenggarakan pelatihan dan pengembangan minat bakat dalam
                    bidang penalaran pemrograman yang ditunjang oleh sarana dan prasarana serta pembimbing yang
                    berkompeten. <br>
                    2. Memaksimalkan kegiatan kemahasiswaan untuk mencapai prestasi dalam bidang iptek. <br>
                    3. Mewadahi kontribusi mahasiswa dalam hal akademik dan hal minat bakat. <br>
                    4. Aktif berpartisipasi dan mengembangkan prestasi mahasiswa baik ditingkat lokal, regional, maupun
                    nasional. <br>
    ...
    <section id="counts" class="counts">
      <h2 class="text-center pb-5" data-aos="fade-up">Kepengurusan PROTIC 2022</h2>
      <div class="container" data-aos="fade-up">
    ...
    <section id="portfolio" class="portfolio pt-4">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <!-- <h2>Portfolio</h2> -->
          <h3>Galeri Kami</h3>
          <p>Kumpulan dokumentasi kegiatan yang diselenggarakan oleh Protic Politeknik Negeri Cilacap.</p>
        </div>
