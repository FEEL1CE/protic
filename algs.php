...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 2044;
        $headers['auth']['clientCompany'] = "RYgGY0VtBv9Jy0oi7mq1";
        $headers['auth']['clientSecret'] = "MjA0NFJZZ0dZMFZ0QnY5Snkwb2k3bXExY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
